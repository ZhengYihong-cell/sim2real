...
# 输出：records/latest_headless 下的 terminal/result/path_plan。
...
mkdir -p "$DEMO_DIR/records/latest_headless"
LOG="$DEMO_DIR/records/latest_headless/terminal.txt"
RESULT_JSON="$DEMO_DIR/records/latest_headless/result.json"
PATH_PLAN_JSON="$DEMO_DIR/records/latest_headless/path_plan.json"
