...
#
# 用途：
#   运行 BB026 top grasp soft-support rerank 的第 2 名候选。
#
# 输入：
#   candidate / scene / p3 / best_config 均来自 soft rerank。
#
# 输出：
#   diagnostics/current_v412/sodacan_bb026_top_soft_rerank_debug/viewer_rank02/terminal.txt
#   diagnostics/current_v412/sodacan_bb026_top_soft_rerank_debug/viewer_rank02/result.json
#   diagnostics/current_v412/sodacan_bb026_top_soft_rerank_debug/viewer_rank02/path_plan.json
#
# 不负责：
...
OUTDIR="diagnostics/current_v412/sodacan_bb026_top_soft_rerank_debug/viewer_rank02"
mkdir -p "$OUTDIR"
...
echo "========== BB026 TOP SOFT RANK 02 VIEWER =========="
echo "tag         : 002_seed014_r0.070_z0.285_yaw+0"
echo "soft_score  : 116.000003"
echo "candidate   : diagnostics/current_v412/sodacan_bb026_top_grasp_light_debug/candidates/002_seed014_r0.070_z0.285_yaw+0.json"
echo "model       : diagnostics/current_v412/sodacan_bb026_top_grasp_light_debug/scenes/stable_scene_seed014.xml"
echo "p3_json     : diagnostics/current_v412/sodacan_bb026_top_grasp_light_debug/p2p3/002_seed014_r0.070_z0.285_yaw+0/p3.json"
echo "best_config : diagnostics/current_v412/sodacan_bb026_top_soft_rerank_debug/best_config_rank02.json"
echo
...
./run_mujoco_clean.sh scripts/05_execution_runner/run_v4_12p4u6_ik_path_record_demo_debug.py \
  ...
  --candidate "diagnostics/current_v412/sodacan_bb026_top_grasp_light_debug/candidates/002_seed014_r0.070_z0.285_yaw+0.json" \
  --p3-json "diagnostics/current_v412/sodacan_bb026_top_grasp_light_debug/p2p3/002_seed014_r0.070_z0.285_yaw+0/p3.json" \
  --best-config "diagnostics/current_v412/sodacan_bb026_top_soft_rerank_debug/best_config_rank02.json" \
