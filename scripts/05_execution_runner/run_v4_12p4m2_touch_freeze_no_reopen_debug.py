...
"""
文件名：
    run_v4_12p4m2_touch_freeze_no_reopen_debug.py
...
def run(args):
    ...
    print("\n========== V4.12P4M2 TOUCH-FREEZE-NO-REOPEN ==========")
    ...
    def sequence(viewer=None):
        nonlocal stop_reason, frozen_ready_step, squeeze_base_ctrl_snapshot, final_squeeze_ctrl
    ...
    out = {
        "format": "v4_12p4m2_touch_freeze_no_reopen_debug",
