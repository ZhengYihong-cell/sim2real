...
#
# 用途：
#   运行 BB026 top grasp soft-support rerank 的第 1 名候选。
#
# 输入：
#   candidate / scene / p3 / best_config 均来自 soft rerank。
#
# 输出：
#   diagnostics/current_v412/sodacan_bb026_top_soft_rerank_debug/viewer_rank01/terminal.txt
#   diagnostics/current_v412/sodacan_bb026_top_soft_rerank_debug/viewer_rank01/result.json
#   diagnostics/current_v412/sodacan_bb026_top_soft_rerank_debug/viewer_rank01/path_plan.json
#
# 不负责：
...
OUTDIR="diagnostics/current_v412/sodacan_bb026_top_soft_rerank_debug/viewer_rank01"
mkdir -p "$OUTDIR"
...
echo "========== BB026 TOP SOFT RANK 01 VIEWER =========="
echo "tag         : 004_seed014_r0.070_z0.245_yaw+0"
echo "soft_score  : 133.840003"
echo "candidate   : diagnostics/current_v412/sodacan_bb026_top_grasp_light_debug/candidates/004_seed014_r0.070_z0.245_yaw+0.json"
echo "model       : diagnostics/current_v412/sodacan_bb026_top_grasp_light_debug/scenes/stable_scene_seed014.xml"
echo "p3_json     : diagnostics/current_v412/sodacan_bb026_top_grasp_light_debug/p2p3/004_seed014_r0.070_z0.245_yaw+0/p3.json"
echo "best_config : diagnostics/current_v412/sodacan_bb026_top_soft_rerank_debug/best_config_rank01.json"
echo
...
./run_mujoco_clean.sh scripts/05_execution_runner/run_v4_12p4u6_ik_path_record_demo_debug.py \
  ...
  --candidate "diagnostics/current_v412/sodacan_bb026_top_grasp_light_debug/candidates/004_seed014_r0.070_z0.245_yaw+0.json" \
  --p3-json "diagnostics/current_v412/sodacan_bb026_top_grasp_light_debug/p2p3/004_seed014_r0.070_z0.245_yaw+0/p3.json" \
  --best-config "diagnostics/current_v412/sodacan_bb026_top_soft_rerank_debug/best_config_rank01.json" \
